...
from .serializers import ChangeEmailSerializer, ChangePasswordSerializer, SubscribeSerializer
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                # get stripeToken from frontend call
                ...
                # use payment method for future invoices
                ...
                # create the payment
                payment, created = Payment.objects.get_or_create(user=user)
